...
[survey-feedback-method](survey-feedback-method.md). Treat the eight stages as
...
3. **Diagnosis**: gather data through interviews, observation, surveys,
   ...
   you gather. See [mckinsey-7s-framework](mckinsey-7s-framework.md),
   [burke-litwin-causal-model](burke-litwin-causal-model.md),
...
4. **Feedback**: give the data back to the people it came from, before you give
   ...
   misreadings. See [survey-feedback-method](survey-feedback-method.md).
...
6. **Intervention**: do the work. See
   [interventions-catalog](interventions-catalog.md).
...
* **Software**: a platform group reports "we can't ship fast enough". Diagnosis
  ...
  [conways-law](conways-law.md), [dora-metrics](dora-metrics.md).
...
* [action-research](action-research.md) — the underlying research logic.
